...
Arrays, Linked Lists, Stacks, Queues, Trees, Graphs, Hash Tables, Heaps, and more.

⚙️ Algorithmic Exercises
Sorting, Searching, Recursion, Dynamic Programming, Greedy Algorithms, Graph Traversals, etc.

🧪 Lab Tasks & Assignments
Weekly DSA lab solutions and experiments.

📂 Modular & Well-Structured Code
Each topic is separated into folders for easy navigation.
